...
public class GenerateInvAdapter extends ArrayAdapter<Material> {
    DecimalFormat precision=new DecimalFormat("0.00");
    private final Context context;
    private final List<MaterialList> materials;

    public GenerateInvAdapter(Context context,List<MaterialList> materials) {
        super(context, 0);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null) {
            ...
            layout = (LinearLayout) layoutInflater.inflate(R.layout.invoice_list_item, null);
        }
        else
        {
        ...
        textUnitPrice.setText(precision.format(materialList.getmUnitPrice()));
